...
<body class="bg-black-900 text-white">
            ...
            <div class="grid grid-cols-3 gap-6">
                ...
                <div class="bg-gray-800 rounded-lg shadow-lg p-4">
                    ...
                    <div class="bg-gray-700 rounded-lg p-4 card"
                         ...
                         data-status="운동 진행중"
                         data-progress="80%">
                        <h3 class="text-lg font-bold">런닝메신</h3>
                        <p class="text-sm text-gray-400">2024년 12월 3일 5:00 PM</p>
                        <div class="flex gap-2 mt-3">
                            <span class="bg-blue-500 text-xs px-2 py-1 rounded">근지구력</span>
                            <span class="bg-yellow-500 text-xs px-2 py-1 rounded">채련증진</span>
                        </div>
                ...
                <div class="bg-gray-800 rounded-lg shadow-lg p-4">
                    ...
                    <div class="bg-gray-700 rounded-lg p-4 mb-4 card"
                         ...
                         data-status="완료됨"
                         data-progress="100%">
                        <h3 class="text-lg font-bold">팔 굴향 포기</h3>
   ...
   <div id="new-card-popup" class="popup-overlay">
    ...
    <div class="flex flex-wrap gap-4">
        ...
        <button type="button" class="category-button bg-lime-500 text-white px-4 py-2 rounded" data-value="북부 운동">북부 운동</button>
        <button type="button" class="category-button bg-green-400 text-white px-4 py-2 rounded" data-value="등 운동">등 운동</button>
        <button type="button" class="category-button bg-emerald-400 text-white px-4 py-2 rounded" data-value="어게 운동">어게 운동</button>
        <button type="button" class="category-button bg-cyan-400 text-white px-4 py-2 rounded" data-value="팔 운동">팔 운동</button>
        <button type="button" class="category-button bg-indigo-400 text-white px-4 py-2 rounded" data-value="허리 운동">허리 운동</button>
        <button type="button" class="category-button bg-violet-400 text-white px-4 py-2 rounded" data-value="가승 운동">가승 운동</button>

        <!-- 운동 목적 -->
        <button type="button" class="category-button bg-purple-400 text-white px-4 py-2 rounded" data-value="근력 강화">근력 강화</button>
        <button type="button" class="category-button bg-pink-400 text-white px-4 py-2 rounded" data-value="근지구력">근지구력</button>
        <button type="button" class="category-button bg-rose-500 text-white px-4 py-2 rounded" data-value="채형 안정">채형 안정</button>
        <button type="button" class="category-button bg-rose-400 text-white px-4 py-2 rounded" data-value="유산소">유산소</button>
        <button type="button" class="category-button bg-red-400 text-white px-4 py-2 rounded" data-value="심평 강화">심평 강화</button>
        <button type="button" class="category-button bg-yellow-400 text-white px-4 py-2 rounded" data-value="스트레치는">스트레치는</button>
        <button type="button" class="category-button bg-amber-400 text-white px-4 py-2 rounded" data-value="지방 연소">지방 연소</button>
...
categoryButtons.forEach(button => {
    button.addEventListener('click', () => {
        ...
        newCardForm.addEventListener('submit', (event) => {
            ...
            const statusInput = document.querySelector('#additional-status-container input');
            const status = statusInput ? statusInput.value : '상태 없음';

            const selectedCategories = Array.from(document.querySelectorAll('.category-button.selected')).map(btn => btn.textContent);

            console.log("운동 이름:", title);
            console.log("운동 시간:", time);
            console.log("운동 상태:", status);
